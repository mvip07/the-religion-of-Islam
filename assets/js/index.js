...
if (geo) {
    geo.getCurrentPosition(function (position) {
        ...
        // https://api.openweathermap.org/data/2.5/onecall?lat=47.667&lon=69.3850&exclude=current&appid=de3ae2261305416619b29ff9f5edc781&units=metric
...
if (geo) {
    geo.getCurrentPosition(function (position) {
        ...
        fetch(`https://api.pray.zone/v2/times/dates.json?longitude=${longitude}&latitude=${latitude}&elevation=333&start=${dd_aa_yyyy}&end=2022-03-06`)
